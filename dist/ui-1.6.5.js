 ...
 * 
 */
angular.module('notifier', ['notifier_template.html']).provider('Notify', function () {
  this.options = {
    maxCount: 0,
    timeout: 5000,
    startTop: 10,
