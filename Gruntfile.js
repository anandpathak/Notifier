...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    meta: {
//      modules: 'angular.module("ui", [<%= srcModules %>]);',
//      tplmodules: 'angular.module("ui.tpls", [<%= tplModules %>]);',
      all: 'angular.module("ui", ["ui.tpls", <%= srcModules %>]);',
      banner: ['/*',
               ' * <%= pkg.name %>',
               ' * <%= pkg.homepage %>\n',
  ...
  //Common ui module containing all modules for src and templates
